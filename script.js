// Dog In Pocket Interactive Experience
class DuckInPocket {
    constructor() {
    ...
    duckGoesInPocket() {
        ...
        const pocketRect = this.pocket.getBoundingClientRect();
        const pocketCenterX = pocketRect.left + (pocketRect.width / 2) - (135) + 10; // Center of pocket minus half duck width (270px/2 = 135px) + 10px to the right
    ...
    reset() {
        ...
        const mainTitle = document.querySelector('.main-title');
        mainTitle.textContent = 'Help put the Dog in the pocket!';
